...
import { TrendingUp, Zap, Activity, Shield } from 'lucide-react';

const items = [
  { icon: TrendingUp, value: '48%', label: 'FCP Improvement', desc: 'React Server Components and CDN caching' },
  { icon: Zap, value: '31%', label: 'Memory Reduction', desc: 'Client-side optimization and memoization' },
  { icon: Activity, value: '93%', label: 'Test Coverage', desc: 'Up from 58% with AI-assisted synthesis' },
  { icon: Shield, value: '35%', label: 'Fewer P1 Incidents', desc: 'Proactive observability and faster resolution' },
];

export default function ImpactClient() {
  return (
    <section id="performance" className="py-20 md:py-28 bg-bg-secondary border-y border-border">
